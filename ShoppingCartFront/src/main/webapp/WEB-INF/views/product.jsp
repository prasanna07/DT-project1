	...
	<form:form action="${addAction}" commandName="product" enctype="multipart/form-data">
		<table>
			...
			<tr>
				...
				<td><form:input id="itemimage" path="itemImage" type="file" class="form:input-large" />						
				</td>
			</tr>
			<tr>
		...
		<table class="tg">
			...
			<c:forEach items="${productList}" var="product">
				<tr>
					...
					<td><img src="<c:url value="/resources/images/${product.id}.png" />" width="100" height="75"  alt="image"/></td>
